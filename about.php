<div  id="overview" class='w-full  text-white'>
    ...
    <marquee class="text-xl">
      ...
      Maharaja Surajmal Institute of Technology (MSIT) in New Delhi, India, and Wentworth Institute of Technology (WIT) in Boston, MA USA, are organizing the 2nd International Conference ICAIA-2024 on March 2024. The conference aims to provide a platform for researchers and practitioners from both academia as well as industry to meet and share cutting-edge development in the field of Artificial Intelligence and its Applications.
      </p> 
        </div>
      </div>
</div>   