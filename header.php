<div class='z-[-1] pt-56'>
      ...
      <div class='text-center text-white text-xl md:text-3xl font-[700] absolute top-[250px] w-full mx-auto'>
        <h1 class='z-10 md:tracking-widest tracking-[1px]'>The International Conference on</h1>
        <h1 class="md:tracking-[3px] tracking-[1px]">Artificial Intelligence and Applications 2023</h1>
        <h1 class='mt-4 md:mt-8 tracking-[1px] md:tracking-wide'>Maharaja Surajmal Institute of Technology</h1>
      </div>
      <div class='text-center text-2xl font-[700] mt-4'>
        <h1 class='text-[#fcb810] text-3xl z-10'>Dec 7 - 8, 2023</h1>
