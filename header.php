<div class='z-[-1] pt-56'>
      ...
      <div class='text-center text-white text-xl md:text-3xl font-[700] absolute top-[250px] w-full mx-auto'>
        <h1 class='z-10 md:tracking-widest tracking-[1px]'>International Conference on</h1>
        <h1 class="md:tracking-[3px] tracking-[1px]">Artificial Intelligence and it's Applications</h1>
