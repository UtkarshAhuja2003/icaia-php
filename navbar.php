  ...
  <nav id="navbar" class="bg-[#041C32] z-50 w-full fixed top-0 left-0">
    <div class="md:flex items-center justify-between bg-theme py-1 xl:px-16 px-6 md:px-14">
      ...
      <ul id="nav-links" class="md:flex md:items-center bg-[#041C32] md:bg-[transparent] text-white md:pb-0 pb-12 font-defaultFont absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in top-[-490px]">
        <li class="lg:ml-6 md:ml-2 sm:tracking-tighter md:text-[10px] lg:text-[11px] xl:text-lg font-normal xl:tracking-wider leading-5 md:my-0 my-7">
