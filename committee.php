  ...
  <div class="w-full" id="committee">
    <div class=' bg-white md:px-[10%]  pt-12'>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 mt-8">
        <button class="tab text-lg rounded-lg text-white w-[80%] py-1 bg-[#041C32]" onclick="changeTab(1)">Organising Committee</button>
        <button class="tab text-lg rounded-lg text-black w-[80%] py-1 bg-white" onclick="changeTab(2)">Advisory Committee</button>
        <button class="tab text-lg rounded-lg text-black w-[80%] py-1 bg-white" onclick="changeTab(3)">Technical Program Committee</button>
      </div>
