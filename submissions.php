...
<div class='w-full text-white'>
    ...
    •	to communicate with you regarding the specific event for which you registered <br>
    •	for our internal reporting purposes <br>
    •	as reasonably necessary for the management and organization of the specific event for which you registered <br>
    ...
    <p class="text-lg text-justify">To comply with ethical standards as well as to provide appropriate context for published work, citations of the author’s own articles should not be excessive.</p>
    <p class='text-md md:text-xl  pt-4 pb-2 font-[700]'>
    Citation Style
    </p> 
    <p class="text-lg text-justify">The list of references should only include works that are cited in the text and that have been published or accepted for publication. Personal communications and unpublished works should only be mentioned in the text. Do not use footnotes or endnotes as a substitute for a reference list. The entries in the list should be numbered consecutively and cited in numerical order, and citations in the text should be identified in IEEE referencing format.</p>
    <p class='text-md md:text-xl  pt-8 pb-2 italic font-[700]'>
    AFTER ACCEPTANCE
    </p>
    <p class='text-md md:text-xl  pt-4 pb-2 font-[700]'>
    ...
    <p class="text-lg text-justify">Originality of the manuscript submitted is the author(s) responsibility, and author(s) must avoid duplicate submission and publication, plagiarism, and self-plagiarism. All manuscript submissions will be screened against the  CrossCheck database.</p>
    <p class='text-md md:text-xl  pt-8 pb-2 font-[700]'>
    Ethics
    </p>
    <p class="text-lg text-justify">Originality of the manuscript submitted is the author(s) responsibility, and author(s) must avoid duplicate submission and publication, plagiarism, and self-plagiarism. All manuscript submissions will be screened against the  CrossCheck database.</p>
    ...
    <p class="text-lg text-justify">When an article is submitted, it is implied that publication has been approved by all author(s)/ co-author(s). Further, changes to the co-author list are not permitted after the manuscript has been accepted. Exceptional cases may be considered by the Editor.</p>
    <p class='text-md md:text-xl  pt-8 pb-2 font-[700]'>
    Corresponding Author Guidelines
    </p>
    <p class="text-lg text-justify">The Corresponding Author is here referred to the author who will be doing the e-mail correspondence with ICAIA-2024, irrespective of the author position in author sequence. In addition to the content of manuscript, Corresponding Author will solely be responsible for putting the name and details of other authors/ co-authors in the submission manuscript. Conference committee explicitly considers that all the authors/ co-authors has/ have contributed to the submission and their consent has/ have been taken to put their name in the submission by the corresponding/ first author.</p>
    <p class='text-md md:text-xl  pt-8 pb-2 font-[700]'>
    Headings
    </p>
    <p class="text-lg text-justify">Please prefer not to use more than three levels of displayed headings.</p>
    <p class='text-md md:text-xl  pt-8 pb-2 font-[700]'>
    Abbreviations
    </p>
    <p class="text-lg text-justify">Abbreviations should be defined at first mention and used consistently after that occurrence. If the abbreviation occurs first in the abstract, it should be defined both there and at first mention in the text.</p>
    <p class='text-md md:text-xl  pt-8 pb-2 font-[700]'>
    e-mailing and Notifications
    </p>
    <p class="text-lg pb-16 text-justify">After the submission of the manuscripts in ICAIA-2024 authors will be notified by e-mail(s) only. ICAIA-2024 will not be held liable for any lapses in e-mail communication, like non-receipt of mail, mail going junk/ spam folder and similar glitches alike.</p> -->
